...
#include "Map.h"
#include "Tracking.h"
#include "/home/ente/my_code/orb_vio/src/IMU/configparam.h"
#include <mutex>
...
public:
    ...
    void AddToLocalWindow(KeyFrame* pKF);  //在后面加入新帧，如果满了，剔除windows中的第一帧
    void DeleteBadInLocalWindow(void);  //从localwindows中去除标签为bad的KF
